...
public interface OrderMapper {
    ...
    int deleteByPrimaryKeyTcc(Long orderId);
    ...
    int insertSelectiveTcc(Order record);
    ...
    Order selectByPrimaryKeyTcc(Long orderId);
    ...
    int updateByPrimaryKeySelectiveTcc(Order record);
    ...
    Long queryByPageCount(@Param("type") Integer type,
                          @Param("keywords") String keywords,
                          @Param("userId") String userId,
                          @Param("addTime") Object addTime,
                          @Param("pageSize") int pageSize);
