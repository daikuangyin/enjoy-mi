...
/*        ApplicationContext applicationContext = SpringApplicationContextUtil.getApplicationContext();
        ...
        map.put(CommonConstant.SESSION_USER_NAME_KEY,user.getUserName());
        map.put(CommonConstant.SESSION_USER_ID_KEY,user.getId());
        map.put(CommonConstant.SESSION_USER_REAL_NAME_KEY,user.getRealName());
        map.put(CommonConstant.SESSION_ACCESS_TOKEN,accessToken);
        redisTemplate.opsForHash().putAll("SSO-SESSION-" + user.getId(),map);*/
    }
